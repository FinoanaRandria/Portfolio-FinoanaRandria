          ...
          <div className="nav__menu" id="nav-menu">
            <ul className="nav__list grid">
              <li className="nav__item">
                <a href="#Home" className="nav__link"> <img src={icon4} width={25}/> Home </a>
              </li>
              <li className="nav__item">
                <a href="#About" className="nav__link"><img src={icon7} width={25}/> About</a>
              </li>
              <li className="nav__item">
                <a href="#Skills" className="nav__link"> <img src={icon2} width={25}/> Skills</a>
              </li>
              <li className="nav__item">
                <a href="#Services" className="nav__link"> <img src={icon1} width={25}/> Services</a>
              </li>
              <li className="nav__item">
                <a href="#Portfolio" className="nav__link"> <img src={icon5} width={25}/> Portfolio</a>
              </li>
              <li className="nav__item">
                <a href="#ContactMe" className="nav__link"> <img src={icon6} width={25}/> ContactME</a>
              </li>
            </ul>
